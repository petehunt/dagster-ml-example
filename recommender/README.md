...
You can start writing assets in `recommender/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `recommender_tests` directory and you can run tests using `pytest`:

```bash
pytest recommender_tests
```
